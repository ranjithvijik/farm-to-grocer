        ...
        await prisma.product.createMany({
            data: [
                ...
                },
                {
                    ...
                    availableQty: 20,
                    isOrganic: true,
                    images: ['https://images.unsplash.com/photo-1589010499687-f1262ec2dcc5?w=800&q=80'],
                },
            ],
        });
            ...
            data: [
                {
                    ...
                    availableQty: 60,
                    isOrganic: false,
                    images: ['https://images.unsplash.com/photo-1588168333986-5078d3ae3942?w=800&q=80'],
                },
                {
                    farmerId: farmer4.id,
