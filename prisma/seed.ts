            ...
            data: [
                {
                    ...
                    availableQty: 40,
                    isOrganic: true,
                    images: ['https://images.unsplash.com/photo-1596489390543-a6cb93851b22?w=800&q=80'],
                },
                {
                    farmerId: farmer3.id,
                    name: 'Arugula',
                    ...
                    availableQty: 20,
                    isOrganic: true,
                    images: ['https://images.unsplash.com/photo-1614735241165-6756e1df61ab?w=800&q=80'],
                },
            ],
        });
        ...
        await prisma.product.createMany({
            data: [
                ...
                },
                {
                    ...
                    availableQty: 20,
                    isOrganic: false,
                    images: ['https://images.unsplash.com/photo-1484156818044-c040038b0719?w=800&q=80'],
                },
            ],
        });
            ...
            data: [
                {
                    ...
                    availableQty: 60,
                    isOrganic: false,
                    images: ['https://images.unsplash.com/photo-1588195538326-c5b1e9f80a1b?w=800&q=80'],
                },
                {
                    farmerId: farmer4.id,
        ...
        await prisma.product.createMany({
            data: [
                ...
                },
                {
                    ...
                    availableQty: 80,
                    isOrganic: true,
                    images: ['https://images.unsplash.com/photo-1517673132405-a56a62b18caf?w=800&q=80'],
                },
            ],
        });
    }
