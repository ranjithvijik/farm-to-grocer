            ...
            data: [
                {
                    ...
                    availableQty: 60,
                    isOrganic: false,
                    images: ['https://images.unsplash.com/photo-1516100882582-96c3a05fe590?w=800&q=80'],
                },
                {
                    farmerId: farmer4.id,
        ...
        await prisma.product.createMany({
            data: [
                ...
                },
                {
                    ...
                    availableQty: 80,
                    isOrganic: true,
                    images: ['https://images.unsplash.com/photo-1510127814815-f6280373df56?w=800&q=80'],
                },
            ],
        });
    }
